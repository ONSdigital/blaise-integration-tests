    ...
    public static class BlaiseConfigurationHelper
    {
        ...
        public static ConnectionModel BuildConnectionModel()
        {
            return new ConnectionModel{
                ServerName = ConfigurationExtensions.GetVariable("ENV_BLAISE_EXTERNAL_SERVER_HOST_NAME"),
                ...
                Binding = ConfigurationExtensions.GetVariable("ENV_BLAISE_EXTERNAL_SERVER_BINDING"),
